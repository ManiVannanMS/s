...
class MAX30102():
	...
	#Set Temperature sensor to read temperature.
    ...
    def read_temperature(self):
            """This function is manually added to read temperature."""
	    self.bus.write_i2c_block_data(self.address, REG_TEMP_CONFIG, [0x01])
	    print("Refreshed Temp register")
	    intr = self.bus.read_i2c_block_data(self.address, REG_TEMP_INTR, 2)
            self.bus.write_i2c_block_data(self.address, REG_TEMP_CONFIG, [0x00])
	    return intr[0]+(intr[1]*0.0625)
